...
<body>
    ...
    <?php 
        ...
        // echo 'Proses : '.$proses;
        // echo '<br>My Nama : '.$nama;
        // echo '<br>My Mata Kuliah : '.$matkul;
        // echo '<br>My Nilai UTS : '.$nilai_uts;
        // echo '<br>My Nilai UAS : '.$nilai_uas;
        // echo '<br>My Nilai Tugas Praktikum : '.$nilai_tugas;
    ?>
